...
public class GA_FREE_OpenOtherScene : MonoBehaviour
{
	...
	public void ButtonOpenDemoScene1 ()
	{
		...
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo01 (960x600px)", 1.5f);
	...
	public void ButtonOpenDemoScene2 ()
	{
		...
		// Waits 1.5 secs for Moving Out animation then load next level
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo02 (960x600px)", 1.5f);
	...
	public void ButtonOpenDemoScene3 ()
	{
		...
		// Waits 1.5 secs for Moving Out animation then load next level
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo03 (960x600px)", 1.5f);
	...
	public void ButtonOpenDemoScene4 ()
	{
		...
		// Waits 1.5 secs for Moving Out animation then load next level
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo04 (960x600px)", 1.5f);
	...
	public void ButtonOpenDemoScene5 ()
	{
		...
		// Waits 1.5 secs for Moving Out animation then load next level
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo05 (960x600px)", 1.5f);
	...
	public void ButtonOpenDemoScene6 ()
	{
		...
		// Waits 1.5 secs for Moving Out animation then load next level
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo06 (960x600px)", 1.5f);
	...
	public void ButtonOpenDemoScene7 ()
	{
		...
		// Waits 1.5 secs for Moving Out animation then load next level
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo07 (960x600px)", 1.5f);
	...
	public void ButtonOpenDemoScene8 ()
	{
		...
		// Waits 1.5 secs for Moving Out animation then load next level
		GUIAnimSystem.Instance.LoadLevel("GA FREE - Demo08 (960x600px)", 1.5f);
