...
public class GA_FREE_Demo01 : MonoBehaviour
{
	...
	public GUIAnim m_TopLeft_A;
	public GUIAnim m_TopLeft_B;
	
	// GUIAnimFREE objects of BottomLeft buttons
	public GUIAnim m_BottomLeft_A;
	public GUIAnim m_BottomLeft_B;
	
	// GUIAnimFREE objects of RightBar buttons
	public GUIAnim m_RightBar_A;
	public GUIAnim m_RightBar_B;
	public GUIAnim m_RightBar_C;
	...
	IEnumerator MoveInPrimaryButtons()
	{
		...
		// MoveIn all primary buttons
		m_TopLeft_A.MoveIn(GUIAnimSystem.eGUIMove.Self);
		m_BottomLeft_A.MoveIn(GUIAnimSystem.eGUIMove.Self);
		m_RightBar_A.MoveIn(GUIAnimSystem.eGUIMove.Self);
	...
	{
		m_TopLeft_A.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		m_BottomLeft_A.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		m_RightBar_A.MoveOut(GUIAnimSystem.eGUIMove.Self);
		
		if(m_TopLeft_IsOn == true)
			m_TopLeft_B.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		if(m_BottomLeft_IsOn == true)
			m_BottomLeft_B.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		if(m_RightBar_IsOn == true)
			m_RightBar_B.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
	...
	void ToggleTopLeft()
	{
		...
		if(m_TopLeft_IsOn==true)
		{
			...
			m_TopLeft_B.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleBottomLeft()
	{
		...
		if(m_BottomLeft_IsOn==true)
		{
			...
			m_BottomLeft_B.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleRightBar()
	{
		...
		if(m_RightBar_IsOn==true)
		{
			...
			m_RightBar_A.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
			// m_RightBar_B moves in
			m_RightBar_B.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_RightBar_A moves in
			m_RightBar_A.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
