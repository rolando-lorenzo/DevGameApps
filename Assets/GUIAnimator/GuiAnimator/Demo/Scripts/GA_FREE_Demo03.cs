...
public class GA_FREE_Demo03 : MonoBehaviour
{
	...
	public GUIAnim m_Dialog1;
	public GUIAnim m_Dialog2;
	public GUIAnim m_Dialog3;
	public GUIAnim m_Dialog4;
	...
	IEnumerator ShowDialogs()
	{
		...
		// MoveIn dialogs
		m_Dialog1.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);		
		m_Dialog2.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);		
		m_Dialog3.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);		
		m_Dialog4.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
	...
	{
		// MoveOut dialogs
		m_Dialog1.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		m_Dialog2.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		m_Dialog3.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		m_Dialog4.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
