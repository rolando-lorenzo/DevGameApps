...
public class GA_FREE_Demo08 : MonoBehaviour
{
	...
	public GUIAnim m_CenterButtons;
	...
	public GUIAnim m_Bar1;
	public GUIAnim m_Bar2;
	public GUIAnim m_Bar3;
	public GUIAnim m_Bar4;
	...
	IEnumerator MoveInPrimaryButtons()
	{
		...
		// MoveIn all primary buttons
		m_CenterButtons.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
	...
	{
		// MoveOut all primary buttons
		m_CenterButtons.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		
		// MoveOut all side bars
		if(m_Bar1_IsOn==true)
			m_Bar1.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		if(m_Bar2_IsOn==true)
			m_Bar2.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		if(m_Bar3_IsOn==true)
			m_Bar3.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
		if(m_Bar4_IsOn==true)
			m_Bar4.MoveOut(GUIAnimSystem.eGUIMove.SelfAndChildren);
	...
	void ToggleBar1()
	{
		...
		{
			// m_Bar1 moves in
			m_Bar1.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_Bar1 moves out
	...
	void ToggleBar2()
	{
		...
		{
			// m_Bar2 moves in
			m_Bar2.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_Bar2 moves out
	...
	void ToggleBar3()
	{
		...
		{
			// m_Bar3 moves in
			m_Bar3.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_Bar3 moves out
	...
	void ToggleBar4()
	{
		...
		{
			// m_Bar4 moves in
			m_Bar4.MoveIn(GUIAnimSystem.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_Bar4 moves out
