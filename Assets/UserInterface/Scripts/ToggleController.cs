...
public class ToggleController : MonoBehaviour 
{
    ...
    public delegate void EventToggleState(bool state);
    public event EventToggleState OnToggleState;
	...
	void Start()
	{
        buttonToggle.onClick.AddListener(Switching);
    ...
    public void startToggleState (bool state)
    {
        isOn = state;
        if (isOn)
        {
